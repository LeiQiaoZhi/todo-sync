...
const APP_VERSION = "2026-03-17 01:44";
const APP_COMMIT_MESSAGE = "Lower left task content visually";
...
function syncSubtodoPresentation(todo, panel, trigger, count, body, list, form, input, addButton) {
  ...
  const allSubtodosDone = hasSubtodos && completedCount === subtodos.length;
  ...
  trigger.classList.toggle("is-complete", allSubtodosDone);
